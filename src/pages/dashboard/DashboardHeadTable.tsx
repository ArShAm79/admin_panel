  ...
  return (
    <div className={classes.root}>
      <div className={classes.table}>
        ...
        <Typography className={classes.tablePart}>Collection Banner</Typography>
        <Typography className={classes.tablePart}>Supply</Typography>
        ...
        <Typography className={classes.tablePart}>Reveal Timestamp</Typography>
        ...
        <Typography className={classes.tablePart}>Website Link</Typography>
